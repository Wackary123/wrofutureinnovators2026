...
Behavior summary:
  ...
  - Camera handled via GStreamer pipeline with GPU debayer + flip
"""
...
# --- Camera ---
# Capture resolution baked into the GStreamer pipeline below. The IMX708
# supports 1536x864@90fps natively (verified via gst-launch test). We ask
# for 30fps which is plenty.
# Set CAMERA_FLIP to:
#   0 = no flip
#   1 = counterclockwise
#   2 = 180° rotation  (use this if the camera is mounted upside down)
#   3 = clockwise
#   4 = horizontal flip
